...
type UserRepoI interface {
	...
	DeleteUserById(ctx context.Context, user models.User) error
}

type TodoRepoI interface {
	CreateUser(ctx context.Context, todo models.Todo) error
	...
	DeleteTodoById(ctx context.Context, todoId models.Todo) error
}
